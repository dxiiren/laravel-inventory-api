...
upload-product-laravel-excel/
  app/
    ...
    Jobs/
      ImportProductsFromExcelJob.php   # queued; sheet-count guard; deletes file when done
    Models/
    ...
    Repositories/ProductRepository.php # queries, CRUD, import dispatch
  ...
  routes/
    api.php                            # /api/products CRUD + import (ApiDataResponse group)
    web.php                            # GET / → welcome
  ...
  tests/
    ...
    Feature/ProductGraphqlTest.php     # GraphQL queries
